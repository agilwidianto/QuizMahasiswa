...
{
    public partial class ReportBarang001 : Form
    {
        public ReportBarang001()
        {
            InitializeComponent();
        }

        private void ReportBarang001_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'quizDataSet1.tbl_barang' table. You can move, or remove it, as needed.
            this.tbl_barangTableAdapter.Fill(this.quizDataSet1.tbl_barang);
        ...
        public void exportgridtopdf(DataGridView dgw, string filename)
        {
            ...
            foreach (DataGridViewColumn column in dgw.Columns)
            {
                ...
                Phrase(column.HeaderText, text));
                cell.BackgroundColor = new
