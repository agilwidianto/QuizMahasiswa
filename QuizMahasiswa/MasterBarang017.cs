...
{
    public partial class MasterBarang017 : Form
    {
        SqlConnection con = new SqlConnection(@"Data Source=LAPTOP-M8GGGF4A\SQLEXPRESS;Initial Catalog=Quiz;Integrated Security=True;");
        public MasterBarang017()
        {
            InitializeComponent();
        }
        ...
        private void MasterBarang017_Load(object sender, EventArgs e)
        {
